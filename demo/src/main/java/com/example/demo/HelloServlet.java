...
public class HelloServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (page) {
            ...
            case ("3"):
                ...
                break;
            case ("4"):
                RequestDispatcher requestDispatcher4 = req.getRequestDispatcher("index.html");
                requestDispatcher4.forward(req, resp);
                break;
            case ("5"):
                RequestDispatcher requestDispatcher5 = req.getRequestDispatcher("write.html");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String pathStr = "C:\\Users\\USER\\IdeaProjects\\servettt\\demo\\src\\main\\webapp\\jsom.txt";
